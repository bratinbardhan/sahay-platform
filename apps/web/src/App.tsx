...
function InnerApp() {
  ...
  return (
    <div className="flex print:block print:h-auto print:max-h-none h-screen w-full bg-slate-50 overflow-hidden print:overflow-visible relative">
      {!session && isAuthPage && (
        <div className="fixed inset-0 overflow-hidden pointer-events-none z-0 bg-gradient-to-br from-teal-50 via-slate-50 to-teal-100">
